...
namespace POS
{
    ...
    public partial class WindowProductCategory : Window
    {
        ...
        private void BtnSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            int id = EntityDBClass.Create("spProductCategory", new string[] {"@Type","@CategoryParentID","@CategoryFullName","@CategoryShortName","@CategoryDescription" , "@recordStatusID" , "@recordStatusCause" , "@recordLastModifiedBy" , "@recordLastModifiedDate" , "@recordEntryBy" , "@recordEntryDate"
            }, new string[] { "1",  CmbCategoryParent.SelectedValue.ToString(), TxtCategoryFullName.Text.ToString(), TxtCategoryShortName.Text.ToString(), TxtCategoryDescription.Text.ToString() , CmbStatus.Text , TxtRecordStatusCause.Text , null , null , null , null  } );
          //  ------ Garments Storelanches  
